...
export function SaveSessionModal({ isOpen, onClose, sessionId, sessionTitle }: SaveSessionModalProps) {
    ...
    <div className='bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4'>
      <Card className='w-full max-w-md'>
        <CardHeader className='relative'>
          ...
          <CardTitle className='text-xl font-semibold text-gray-900'>Save this session?</CardTitle>
          <CardDescription>Save this session with Google login and access it later.</CardDescription>
        </CardHeader>
        <CardContent className='space-y-6'>
          ...
          {/* Action Buttons */}
          <div className='space-y-3'>
            <Button onClick={handleGoogleLogin} disabled={isLoading} className='w-full bg-blue-600 hover:bg-blue-700'>
              {isLoading ? (
                <div className='flex items-center space-x-2'>
