    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100'>
      ...
      <div className='container mx-auto px-4 py-12'>
        <div className='mb-12 text-center'>
          <h1 className='mb-4 text-4xl font-bold text-gray-900'>Try Our Demo Sessions</h1>
            ...
            <Card className='border-2 border-blue-200 bg-blue-50'>
              ...
              <CardContent className='space-y-4'>
                <div className='rounded-lg bg-white p-4'>
                  <h4 className='mb-2 font-medium'>What you&apos;ll experience:</h4>
        ...
        {!selectedDemo && (
          <div className='text-center'>
            <p className='mb-6 text-gray-600'>Select a demo session above to get started</p>
