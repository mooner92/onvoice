        ...
        <div className='container mx-auto px-4 py-4'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center space-x-4'>
              <Button variant='ghost' size='sm' asChild className='-ml-2 pr-2 pl-0'>
          ...
          {session?.status === 'ended' && (
            <div
              className={`mb-8 rounded-lg border-2 border-dashed p-6 ${
                darkMode ? 'border-gray-600 bg-gray-800' : 'border-blue-200 bg-blue-50'
              }`}
            >
              ...
              <div className={`rounded-lg p-4 ${darkMode ? 'bg-gray-700' : 'bg-white'}`}>
                {summaryLoading && (
                  <div className='flex items-center space-x-3 py-8 text-center'>
                    ...
                    <div>
                      <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>AI 요약 생성 중...</p>
                      <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                ...
                {summaryError && (
                  <div className='py-8 text-center'>
                    ...
                    <p className={`mb-4 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{summaryError}</p>
                ...
                {summary && (
                  <div className='space-y-4'>
                    ...
                    <div
                      className={`leading-relaxed ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}
                    ...
                    <div className='flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600'>
                      ...
                      <div className='flex space-x-2'>
                        <Button
                          ...
                          onClick={() => {
                            const summaryToCopy =
                              showTranslation && selectedLanguage !== 'en' ? translatedSummary || summary : summary
                ...
                {!summary && !summaryLoading && !summaryError && (
                  <div className='py-8 text-center'>
                    <div className={`mb-4 text-6xl ${darkMode ? 'text-gray-600' : 'text-gray-300'}`}>📄</div>
